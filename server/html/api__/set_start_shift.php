...
mail($driver['driver_email'], 'Defects report for '.$vehicle_reg, stripslashes($email_message), $mail_headers);
mail('info@flightlinkwales.com', 'Defects report for '.$vehicle_reg, stripslashes($email_message), $mail_headers);
mail('mohammed.islam@flightlinkwales.com', 'Defects report for '.$vehicle_reg, stripslashes($email_message), $mail_headers);
#mail('istanley42@gmail.com', 'Defects report for '.$vehicle_reg, stripslashes($email_message), $mail_headers);
